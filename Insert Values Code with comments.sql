...
----inserting values into the Executive Team table
...
------inserting values into the Activites Team table
...
------inserting values into the Media Team table
...
------inserting values into the collaborated events table

insert into collaborated_events 
select * from event where Collaborated_Event='Y';

------inserting values into the collaborators table
...
------inserting values into the internal collaborators table
...
------inserting values into the external collaborators table
...
------inserting values into the event_collaborated table
...
------inserting values into the media content table
...
------inserting values into the Budget table
...
------inserting values into the Bills table
